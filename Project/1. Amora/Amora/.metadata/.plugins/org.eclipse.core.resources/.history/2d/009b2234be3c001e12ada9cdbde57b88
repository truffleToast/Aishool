											...
											<div
												...
												<%
													...
													<%
															...
															String imagePath = dao2.sh_img_share(list.get(i).getSh_Num());
														...
														<div
															...
															<div class="text-center">
																...
																<a class= "btn btn-outline-dark mt-auto"
																	href="Share_ViewCountUpService?sh_Num=<%=list.get(i).getSh_Num()%>&sh_likes=<%=list.get(i).getSh_likes()%>"> 
																	<!--  서블렛을 통해 조회수를 1 올리고 넘어가도 됨 그게 바람직 하다-->>
																	상세보기</a>
															</div>
														</div>
