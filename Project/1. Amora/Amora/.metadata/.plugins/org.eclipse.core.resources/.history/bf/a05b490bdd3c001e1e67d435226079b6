					...
					<div class="topmargin">
						<div class="board_wrap">
							<div class="board_title">
								<h1 style ="font-size:40px;"><b> 나눔게시판 </b></h1>
								<!-- 헤더 아래 커뮤니티 크기 키움, 아래는 수평선 크기 임. -->
								<hr style="border: 2px solid #000">
								<p>이웃끼리 서로 나누고 베푸는 우리 아파트!</p>
							</div>
							...
							<form action="ShareService" method="post" enctype = "multipart/form-data">
								<div class="board_list">
									<div style="float: left;">
											...
											<input type ="hidden" name="share" value="share"> <!-- 글쓰기 칸에서 카테고리 선택 x -->
											<input type ="hidden" name="section" value="F">
									</div>
