...
<body>
 ...
 <div  class="container" >
	<div  class="row">
		<form method="post" action="con_updateAction?gb_Num=<%=gb_Num%>">
		    <table class="table table-striped" style="text-align: center; border: 4px solid #dddddd; position:relative; top: 100px; ">
		        ...
		        <tbody>
		            <tr>
		                <td><input type="text" class="form-control" placeholder="글 제목" name="gb_title" maxlength="50" value="<%= dto.getGb_Title() %>"></td>
		            </tr>
		            <tr>
		                <td><textarea class="form-control" placeholder="글 내용" name="gb_content" maxlength="2048" style="height: 350px"><%= dto.getGb_Content()%></textarea></td>                        
		            </tr>
		        </tbody>
		    </table>
