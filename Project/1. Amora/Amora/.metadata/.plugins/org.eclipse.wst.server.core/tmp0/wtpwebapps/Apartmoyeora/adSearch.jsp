			...
			<div class="gtco-container">
				<div class="row">
					<div class="topmargin">
						...
						<div class="board_wrap">
							<div class="board_title">
								<h1 style ="font-size:40px;"><b>홍보</b></h1>
							...
							AdDAO dao = new AdDAO();
							ArrayList<AdDTO> list_Search = new ArrayList<>();
							...
							<tr style="background-color: white;">
								...
								<td><%=list_Search.get(i).getAd_Num()%></td>
								<td><a
									href="ad_view.jsp?ad_Num=<%=list_Search.get(i).getAd_Num()%>"><%=list_Search.get(i).getAd_Title()%></a></td>
								<td><%=list_Search.get(i).getNickname()%></td>
								<td><%=list_Search.get(i).getAd_Date().substring(0, 11) + list_Search.get(i).getAd_Date().substring(11, 13) + ":"+ list_Search.get(i).getAd_Date().substring(14, 16)%></td>
								<td><%=list_Search.get(i).getAd_Views()%></td>
							</tr>
							<%
							}
							%>
							...
							<%-- 페이지 개수 숫자 나오는 곳	<% 
									...
									<% } %>  --%>
							<a href="ad_write.jsp" class="btn btn-primary pull-right">글쓰기</a>
						</div>
					</div>
					...
					<div
						...
						<form action="adSearch.jsp" method="get">
							<select name="col">
