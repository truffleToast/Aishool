					...
					<div class="topmargin">
						...
						<div class="board_wrap">
							...
							if ("title_content".equals(col)) {
								list_Search = dao.getListShare_Search_Title_Content(sentence, pageNumber);
								/* 카테고리가 내용과 일치하면 */
							} else if ("content".equals(col)) {
								list_Search = dao.getListShare_Search_Content(sentence, pageNumber);
								/* 카테고리가 제목과 일치하면 */
							} else if ("title".equals(col)) {
								list_Search = dao.getListShare_Search_Title(sentence, pageNumber);
								/* 카테고리가 작성자와 일치하면 */
							} else if ("writer".equals(col)) {
								list_Search = dao.getListShare_Search_Writer(sentence, pageNumber);
							}
