...
<div class = "reply.wrap">
   ...
   <hr>
   <h3>댓글창</h3>
      <div style="margin: 0 5%; padding-left: 10px; ">
   ...
   <input type ="hidden" name ="com_Num" value ="<%= com_Num %>">
   <textarea name="com_content" cols="80" rows ="2" id = "com_content" style="padding-left:10%; "></textarea>
    <button type="submit" class="border-none" style="font-size: 60%;">댓글 등록</button>
...
function showReReplyUpdateForm(index) {
   ...
   <footer style="padding-top:0px;position:relative; top: 100px; left: 100px;" id="gtco-footer" role="contentinfo">
      <div class="gtco-container">
