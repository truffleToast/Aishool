			...
			<div class="gtco-container">
				<div class="row">
					<div class="topmargin">
					 ...
					 <form action ="con_writee" method="post" enctype = "multipart/form-data">
						<div class="board_wrap">
							...
							<div class="board_list_wrap">
								...
								<div class="board_list">
									...
									<textarea name="gb_Title" style="height: 40px; width: 840px; resize: none; overflow: hidden; text-align: left;" placeholder="제목입력"></textarea>
									<div>
                                      
										    <label for="dateInput">날짜 선택:</label>
										    <input type="date" id="gb_Period" name="gb_Period">
										
                                    </div>
									<div>
									    <textarea name="gb_Content" rows="10" cols="65" style="width: 840px;" placeholder="관리자의 판단하에 비방글은 삭제 됩니다."></textarea>
									</div>
                            ...
                            <div style="position: relative; top: 30px; left: 350px;" class="bt_wrap">
                                ...
                                <a style="border: 3px solid #7297F7; color: black;" href="contact.jsp">취소</a>
                            </div>
                    	</div>
				</form>
