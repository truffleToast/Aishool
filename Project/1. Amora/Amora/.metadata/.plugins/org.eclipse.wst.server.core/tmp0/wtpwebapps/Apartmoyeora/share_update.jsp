...
<body>
 ...
 <div  class="container" >
	<div  class="row">
		<form method="post" action="share_updateAction?sh_Num=<%=sh_Num%>">
			<table class="table table-striped" style="text-align: center; border: 4px solid #dddddd; position:relative; top: 100px; ">
			<thead>
				<tr>
			...
			<!--  글 내용 넣기 -->
				<tr>
					<td><input type="text" class="form-control" placeholder="글 제목" name="sh_title" maxlength="50" value="<%= dto.getSh_title() %>"></td>
				</tr>
				<tr>
					<td><textarea class="form-control" placeholder="글 내용" name="sh_content" maxlength="2048" style="height: 350px"><%= dto.getSh_content()%></textarea></td>						
				</tr>
			</tbody>
		</table>
		<input  style="position: relative; top:110px;"type="submit" id="editBtn" class="btn btn-primary pull-right" value="글  수정">
		</form>						
	</div>
</div> <!-- container태그 끝  -->
