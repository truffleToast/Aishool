 ...
 * Generated at: 2023-08-17 09:35:28 UTC
...
public final class userjoin_jsp extends org.apache.jasper.runtime.HttpJspBase
  ...
  public void _jspService(final javax.servlet.http.HttpServletRequest request, final javax.servlet.http.HttpServletResponse response)
    ...
    try {
      ...
      out.write("								<p>회원가입 페이지 입니다.</p>\r\n");
      out.write("							</div>\r\n");
      out.write("							\r\n");
      out.write("							<!-- 백엔드 연결주소 -->\r\n");
      out.write("							<form action=\"");
      out.write((java.lang.String) org.apache.jasper.runtime.PageContextImpl.proprietaryEvaluate("${pageContext.request.contextPath}", java.lang.String.class, (javax.servlet.jsp.PageContext)_jspx_page_context, null));
      out.write("/userJoin\" method=\"post\" id = \"Inputform\">\r\n");
      out.write("							\r\n");
      ...
      out.write("																<label for=\"activities\">ID</label>\r\n");
      ...
      out.write("														<div class=\"row form-group\">\r\n");
      out.write("															<div class=\"col-md-12\">\r\n");
      out.write("																<label for=\"activities\">이름</label>\r\n");
      out.write("																<input type=\"text\" id=\"name\" name=\"name\" placeholder = \" 이름 입력\" class=\"form-control\">				\r\n");
      out.write("															</div>\r\n");
      out.write("														</div>\r\n");
      out.write("														\r\n");
      out.write("														<div class=\"row form-group\">\r\n");
      ...
      out.write("																<input type=\"number\" id=\"phone\" name=\"phone\" placeholder = \" 숫자만 입력해주세요\" class=\"form-control\">	\r\n");
      out.write("															</div>\r\n");
      out.write("														</div>\r\n");
      out.write("														\r\n");
      out.write("														<div class=\"row form-group\">\r\n");
      ...
      out.write("														<div class=\"row form-group\">\r\n");
      out.write("															<div class=\"col-md-12\">\r\n");
      out.write("																<label for=\"activities\">생년월일</label>\r\n");
      ...
      out.write("															    <label style=\"font-size: 80%; margin-right: 50px;\"for=\"gender_male\">\r\n");
      out.write("															      남자 <input type=\"radio\" value=\"남자\" id=\"gender_male\" name=\"gender\" style=\"width: 20px; height: 20px; border: 1px;\">\r\n");
      out.write("															    </label>\r\n");
      out.write("															    <label style=\"font-size: 80%\"; for=\"gender_female\">\r\n");
      out.write("															      여자 <input type=\"radio\" value=\"여자\" id=\"gender_female\" name=\"gender\" style=\"width: 20px; height: 20px; border: 1px;\">\r\n");
      out.write("															    </label>									\r\n");
      out.write("															</div>\r\n");
      out.write("														</div>\r\n");
      out.write("														\r\n");
      out.write("														<div class=\"row form-group\">\r\n");
      out.write("													<div class=\"col-md-12\">\r\n");
      out.write("														<label for=\"activities\">아파트등록</label>\r\n");
      out.write("														<div style=\"display: flex; justify-content: center; float: right; margin-right: 630px;\">\r\n");
      out.write("														  <input type=\"button\" onclick=\"findMyApart()\" value=\"아파트 검색\" class=\"form-control\" style=\"width: 200px !important;\">\r\n");
      out.write("														</div>\r\n");
      out.write("														\r\n");
      out.write("														<div style=\"line-height:50%;\">\r\n");
      out.write("															<input type=\"text\" id= \"addr\" name=\"addr\" placeholder=\"주소\" class=\"form-control\"><br>\r\n");
      out.write("															<input type=\"text\" id= \"dongho\" name=\"dongho\" placeholder=\"동, 호수\" class=\"form-control\"><br>\r\n");
      out.write("															<input type=\"text\" id=\"sample6_extraAddress\" placeholder=\"참고항목\" class=\"form-control\">	\r\n");
      out.write("														</div>													\r\n");
      out.write("													</div>\r\n");
      out.write("												</div>\r\n");
      out.write("														\r\n");
      ...
      out.write("														<div class=\"row form-group\">\r\n");
      out.write("															<div class=\"col-md-12\">\r\n");
      out.write("																<input type=\"submit\" id = \"adminjoin\" class=\"btn btn-primary1 btn-block\" value=\"회원가입하기\">\r\n");
      out.write("															</div>\r\n");
      out.write("														</div>\r\n");
      out.write("												\r\n");
      out.write("												</div>\r\n");
      ...
      out.write("		<!-- 주소API -->\r\n");
      out.write("		<script>\r\n");
      out.write("		   function findMyApart() {\r\n");
      ...
      out.write("		                document.getElementById(\"dongho\").focus();\r\n");
      out.write("		            }\r\n");
      out.write("		        }).open();\r\n");
      out.write("		     \r\n");
      out.write("		     <!-- 폼 입력조건 안채워지면 실행안되게 -->\r\n");
      out.write("		     \r\n");
      out.write("		  }\r\n");
      out.write("		   document.getElementById('Inputform').addEventListener('submit', function(event) {\r\n");
      out.write("			    var inputs = document.querySelectorAll(\"#Inputform input\"); // 폼 내의 모든 입력 필드 선택\r\n");
      out.write("			    var emptyFieldExists = false;\r\n");
      out.write("			    \r\n");
      out.write("			    for (var i = 0; i < inputs.length; i++) {\r\n");
      out.write("			        var inputValue = inputs[i].value.trim();\r\n");
      out.write("			        \r\n");
      out.write("			        if (inputValue === \"\") {\r\n");
      out.write("			            emptyFieldExists = true;\r\n");
      out.write("			            break; // 빈 값이 하나라도 있으면 반복문 종료\r\n");
      out.write("			        }\r\n");
      out.write("			    }\r\n");
      out.write("			    \r\n");
      out.write("			    if (emptyFieldExists) {\r\n");
      out.write("			        alert(\"모든 필드를 입력하세요.\");\r\n");
      out.write("			        event.preventDefault(); // 제출 막기\r\n");
      out.write("			    }\r\n");
      out.write("			});\r\n");
      out.write("\r\n");
      out.write("		</script>\r\n");
